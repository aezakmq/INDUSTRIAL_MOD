...
- `crude_oil` - неочищенное масло (chemistry 1)
...
1. **Добыча:** Нефтяная вышка → Неочищенное масло
2. **Перегонка:** Печь + Нагреватели + Неочищенное масло → Мазут + Бензин + Дизель + Керосин
3. **Обработка:** Мазут → Моторное масло
4. **Оружие:** Нефть + Мазут → Кустарный напалм
